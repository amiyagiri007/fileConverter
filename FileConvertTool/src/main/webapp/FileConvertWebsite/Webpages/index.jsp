...
<head>
    ...
    <link rel="stylesheet" href="/FileConvertTool/FileConvertWebsite/Asset/Css/styles.css">
...
<body>
    <div id="shapeContainer" class="shape">
		...
		<form action="checkingConverion" method="post" enctype="multipart/form-data">
    ...
    <script src="/FileConvertTool/FileConvertWebsite/Asset/Script/script.js"></script>
</body>
